"""
Django settings for posters_4_u project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', '91h2df=q_zl*_h)m40x48!#iy3fmczub(bkzhv4xw2qm1d+650')
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'posters4u'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'posters4u@example.com'
else:
